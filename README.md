...
mysql -u root
```
- 6 Copie o script de criação do banco de dados e cole no shell do MariaDB **( ./database/script.sql )**, copie também os dados de teste que estão na pasta **( ./tests/data.sql )**
